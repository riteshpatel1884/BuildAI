      ...
      >
        ...
        <div className="flex flex-col gap-1 px-2 pb-4">
          <div className="flex flex-col">
            ...
            >
              <DocIcon />
              <span className="truncate">{LANGSMITH.title}</span>
            </div>

            <div className="ml-3 mt-0.5 flex flex-col gap-0.5 border-l border-zinc-200 pl-2 dark:border-white/10">
              {Object.entries(LANGSMITH.subtopics).map(([subSlug, subtopic]) => {
                const subHref = `/langsmith/${subSlug}`;
                const subActive =
